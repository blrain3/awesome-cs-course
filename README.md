...
Start with the `Intro` and `Core` entries that match your current level, then move toward `Advanced` or `Archived` material when you want a deeper or historically important offering. Use the final texts section for books and course companions that pair well with the main courses.
...
- [MIT 6.100L (formerly 6.0001): Introduction to Computer Science and Programming using Python](https://ocw.mit.edu/courses/6-100l-introduction-to-cs-and-programming-using-python-fall-2022/) - MIT (Archived). The 2022 OCW offering teaches Python, computational thinking, and algorithmic problem solving through assignments and a final project.
- [UC Berkeley CS61A: Structure and Interpretation of Computer Programs](https://cs61a.org/) - UC Berkeley (Intro). The course builds programming fluency through recursion, abstraction, and data-directed programming in Python, Scheme, and SQL.
- [Princeton COS 126: Computer Science: An Interdisciplinary Approach](https://www.cs.princeton.edu/courses/archive/fall26/cos126/) - Princeton University (Intro). The course introduces programming, data, and computational problem solving through lectures, labs, and assignments.

## Mathematics for Computer Science

- [UC Berkeley CS70: Discrete Mathematics and Probability Theory](https://cs70.org/) - UC Berkeley (Core). The course develops proof techniques, counting, probability, and discrete structures for later CS theory.
- [MIT 6.042J: Mathematics for Computer Science](https://ocw.mit.edu/courses/6-042j-mathematics-for-computer-science-spring-2015/) - MIT (Archived). The OCW offering covers logic, proofs, graphs, counting, and discrete probability for computing.
- [Stanford CS109: Probability for Computer Scientists](https://web.stanford.edu/class/cs109/) - Stanford University (Core). The course teaches probability, inference, and statistical reasoning through problem sets and projects.
...
- [UIUC CS225: Introduction to Data Structures and Algorithms with C++](https://courses.grainger.illinois.edu/cs225/fa2026/) - University of Illinois Urbana-Champaign (Core). The course teaches linked structures, trees, hash tables, graphs, and algorithmic problem solving in C++.

## Computer Architecture and Systems

- [UC Berkeley CS61C: Great Ideas in Computer Architecture](https://cs61c.org/) - UC Berkeley (Core). The course moves from C and assembly to caches, pipelines, and parallel performance.
...
- [MIT 6.1810 (formerly 6.S081): Operating System Engineering](https://pdos.csail.mit.edu/6.1810/2025/) - MIT (Archived). The archived offering uses xv6 to teach processes, virtual memory, file systems, and concurrency.
- [UC Berkeley CS162: Operating Systems and Systems Programming](https://cs162.org/) - UC Berkeley (Core). The course combines OS concepts with systems programming, synchronization, and kernel abstractions.
...
- [Stanford CS103: Mathematical Foundations of Computing](https://web.stanford.edu/class/cs103/) - Stanford University (Core). The course teaches proofs, logic, combinatorics, and computability foundations for CS.
...
- [Stanford CS224N: Natural Language Processing with Deep Learning](https://web.stanford.edu/class/cs224n/) - Stanford University (Advanced). The course teaches NLP with embeddings, sequence models, and transformers.
- [Stanford CS336: Language Modeling from Scratch](https://cs336.stanford.edu/) - Stanford University (Advanced). The course studies tokenizer design, transformers, training, and evaluation of language models.
...
- [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) - Text (Core). The free text covers virtualization, concurrency, and persistence.
- [Computer Networking: A Top-Down Approach](https://gaia.cs.umass.edu/kurose_ross/) - Text (Core). The companion site follows networks from the application layer down to the link layer.
